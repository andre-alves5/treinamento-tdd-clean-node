...
import { mockEncrypter, mockHashComparer, mockLoadAccountByEmailReposytory, mockUpdateAccessTokenRepository } from '@/data/test'
...
const makeSut = (): SutTypes => {
  const loadAccountByEmailRepositoryStub = mockLoadAccountByEmailReposytory()
